<template>
    <div class="col-lg-9 z-post-detail">
      <div class="iq-card">
               ...
               <div class="iq-email-to-list p-3">
                  <div class="d-flex justify-content-between">
                     <ul>
                        ...
                        <!-- <li data-toggle="tooltip" data-placement="top" title="" data-original-title="Archive"><a href="#"><i class="ri-mail-open-line"></i></a></li>
                        <li data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete"><a href="#"><i class="ri-delete-bin-line"></i></a></li>
                        <li data-toggle="tooltip" data-placement="top" title="" data-original-title="Inbox"><a href="#"><i class="ri-mail-unread-line"></i></a></li>
                        <li data-toggle="tooltip" data-placement="top" title="" data-original-title="Zoom"><a href="#"><i class="ri-drag-move-2-line"></i></a></li> -->
                     </ul>
                     <div class="iq-email-search d-flex">
                        <form class="mr-3 position-relative">
                           <div class="form-group mb-0">
                              <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Search">
                              <a class="search-link" href="#"><b-icon icon="arrow-counterclockwise" aria-hidden="true"></b-icon></a>
                           </div>
                        </form>
                        <ul>
                           <li class="mr-3">
                           ...
                           <li data-toggle="tooltip" data-placement="top" title="" data-original-title="Reload"><a id="refreshButton" href="#"><b-icon icon="arrow-counterclockwise" aria-hidden="true"></b-icon></a><b-tooltip target="refreshButton" triggers="hover">刷新</b-tooltip></li>
                           <li data-toggle="tooltip" data-placement="top" title="" data-original-title="Next"><a href="#"><b-dropdown  variant="link" no-caret>
    ...
    <b-dropdown-item href="#">Something else here...</b-dropdown-item>
                           ...
                           <!-- <li class="mr-0" data-toggle="tooltip" data-placement="top" title="" data-original-title="Setting"><a href="#"><i class="ri-list-settings-line"></i></a></li> -->
                        </ul>
                     </div>
                  </div>
               </div>
                           ...
                           <li class="iq-unread">
                              <div class="d-flex align-self-center">
                                 ...
                                 <div class="iq-email-content">
                                    <a href="javascript: void(0);" class="iq-email-subject">Mackenzie Bnio (@MackenzieBnio) has sent
                                          ...
                                          <div class="iq-inbox-subject-info">
                                             <div class="iq-subject-info">
                                                ...
                                                <div class="iq-subject-status align-self-center">
                                                   <h6 class="mb-0">SocialV team <a href="dummy@SocialV.com"></a></h6>
                                                   <div class="dropdown">
